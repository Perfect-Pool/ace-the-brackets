...
export const consolationPrize16: ActionFn = async (context: Context, event: Event) => {
    ...
    const CONTRACT_ADDRESS = await context.secrets.get("baseSepolia.aceTicket16.contract");
