...
contract AceTheBrackets16 {
    ...
    uint8 public constant MIN_ACTIVE_TOKENS = 16;
    ...
    modifier onlyGameContract() {
        require(
            gamesHub.games(keccak256("ACE16_PROXY")) == msg.sender,
            "ACE-01"
        );
        _;
    }
    ...
    function advanceGame(
        ...
        uint256[16] memory winnersArray = abi.decode(_winners, (uint256[16]));
        ...
        if (currentRound == 3) {
            ...
            IAceTicket16(gamesHub.helpers(keccak256("ACE16_TICKET"))).setGamePot(
                gameIndex,
                gameCode
            );
    ...
    function _updateTimestamps(uint256 _gameId, uint256 _lastTimeStamp) internal {
        ...
        games[_gameId].rounds[3].start = timer;
        timer += _roundDuration;
        games[_gameId].rounds[3].end = timer;
    ...
    function getFinalResult(
        ...
        brackets[4] = games[gameIndex].rounds[1].tokens[4];
        brackets[5] = games[gameIndex].rounds[1].tokens[5];
        brackets[6] = games[gameIndex].rounds[1].tokens[6];
        brackets[7] = games[gameIndex].rounds[1].tokens[7];
        brackets[8] = games[gameIndex].rounds[2].tokens[0];
        brackets[9] = games[gameIndex].rounds[2].tokens[1];
        brackets[10] = games[gameIndex].rounds[2].tokens[2];
        brackets[11] = games[gameIndex].rounds[2].tokens[3];
        brackets[12] = games[gameIndex].rounds[3].tokens[0];
        brackets[13] = games[gameIndex].rounds[3].tokens[1];
        brackets[14] = games[gameIndex].winner;
    ...
    function getTokensSymbols(
        ...
        uint256[16] memory _tokensArray = abi.decode(_tokens, (uint256[16]));
        for (uint8 i = 0; i < 16; i++) {
    ...
    function getActiveGamesActualCoins() public view returns (bytes[5] memory) {
        bytes[5] memory _activeGamesActualCoins;
